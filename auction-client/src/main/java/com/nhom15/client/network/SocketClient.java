...
public class SocketClient {
    ...
    private static final String SERVER_IP = "100.107.11.12";

    // Cổng này phải khớp với cổng đang chạy ở AuctionServer
    private static final int SERVER_PORT = 8888;

    /**
     * Hàm này nhận vào một JsonObject (yêu cầu từ giao diện),
     * gửi lên Server, và trả về JsonObject (phản hồi từ Server).
     */
