...
public class ApiClient {
    ...
    /**
     * Hàm dùng để gửi yêu cầu HTTP GET đến một đường dẫn (URL) cụ thể.
     * Thường dùng để lấy dữ liệu từ các API công khai trên mạng.
     * * @param url Đường dẫn API (Ví dụ: "https://api.exchangerate-api.com/v4/latest/USD")
