...
/**
 * DTO cho sản phẩm + phiên đấu giá — dùng để hiển thị danh sách và chi tiết. Server trả về
 * camelCase nên không cần @SerializedName.
 */
public class ItemDTO {
  ...
  public void setImageBase64(String v) {
    imageBase64 = v;
  }
  ...
  public void setMinStep(double v) {
    minStep = v;
  }
