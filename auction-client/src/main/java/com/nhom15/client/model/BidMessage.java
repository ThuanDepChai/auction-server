...
/**
 * DTO cho một lượt đặt giá — dùng hiển thị lịch sử bid trong BiddingRoomController.
 * Map trực tiếp với JSON server trả về từ GET_BID_HISTORY.
 */
public class BidMessage {
    ...
    public void   setBidId(int v)         { bidId = v; }
    ...
    public void   setBidTime(String v)    { bidTime = v; }
