...
public class AuctionListController {
  ...
  private void showLoading() {
    flowAuctions.getChildren().setAll(CardFactory.buildEmptyLabel("Đang tải..."));
  }

  private void showEmpty(String msg) {
    flowAuctions.getChildren().setAll(CardFactory.buildEmptyLabel(msg));
    lblCount.setText("0 phiên");
  }
}