...
public class HomeCommand {
  ...
  public static void searchProducts(String keyword, String category, Consumer<JsonArray> onSuccess,
      Runnable onFail) {
  ...
  private static void executeCommand(String action, JsonObject data,
  ...
  private static boolean isSuccess(JsonObject response) {
    return response != null && response.has("status") && "SUCCESS".equals(
