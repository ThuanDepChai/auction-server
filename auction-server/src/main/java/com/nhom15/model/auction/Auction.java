...
public class Auction {
  ...
  public void addBid(Bidder bidder, double amount) {
    ...
    bids.add(bid);
    System.out.println("Người dùng " + bidder.getUsername() + " vừa đặt giá: " + amount + " lúc "
        + bid.getTimestamp());
    String msg =
        "Sản phẩm " + item.getName() + " có giá mới: " + amount + " từ " + bidder.getUsername();
    notifyObservers(
        "Có bid mới: " + amount + " từ " + bidder.getUsername()); // thêm thông báo ( observer)
  }
